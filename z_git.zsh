...
alias cmtnf='git commit --no-verify -m'
...
alias coutt='git checkout -b test'
alias fch='git fetch -a'
alias gd='git branch -D'
alias gdt='git branch -D test'
alias gw='git worktree'
alias gwa='git worktree add ../yampa-worktree'
alias gwd='git worktree remove ../yampa-worktree'
